<?php include('nav.php');  ?>
 ...
 <?php //sql
          $sql = "select * from admin_tbl where `admin_email`='$admin_email'";
...
<?php
 ...
 <div class="container col-sm-6 px-5 my-5">
        <h1 class="text-center">Profile</h1>
         <!-- user information -->
         <form action="" method="POST" >
            <div class="form-group">
              <label for="inputEmail">Email</label>
              <input type="email" name="adminemail" id="inputEmail" class="form-control" value="<?php echo $admin_email; ?>"  readonly>
            </div>
            <div class="form-group">
              <label for="inputName">Name</label>
              <input type="text" name="admin_name" id="inputName" class="form-control" value="<?php echo $admin_name; ?>">
            </div>
